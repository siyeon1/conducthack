...
<p align="center">
  <img src="docs/media/loop-2c-prove.v2.gif" width="640" alt="shft's tamper-evident ledger: an approval is recorded, then a tampered entry makes integrity verification fail, in red">
</p>
...
<p align="center"><img src="docs/media/loop-1-describe.v2.gif" width="600" alt="Typing a change request, generating a dependency DAG, editing a node in words, and approving the plan"></p>
...
<p align="center"><img src="docs/media/loop-2a-understand.v2.gif" width="600" alt="Running Locate, Explain and Impact in the stage cockpit, with culprit lines highlighted"></p>
...
<p align="center"><img src="docs/media/loop-2b-change.v2.gif" width="600" alt="The AI's change shown as an inline diff, then approved with a typed justification at the coral human-approval gate"></p>
...
<p align="center"><img src="docs/media/loop-2c-prove.v2.gif" width="600" alt="Recording an approval to the ledger, then tampering with an entry so integrity verification fails in red"></p>
...
<p align="center"><img src="docs/media/loop-3-trail.v2.gif" width="600" alt="The programme audit trail, the saved-programme library, and the integrations panel"></p>
